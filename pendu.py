...
def erreur():
    messagebox.showinfo(
        "Fampahafantarana", ' Mampidira litera ao anatin\' ny : "A...Z" na "a...z"'
    )
...
labCacher = tk.Label(
    cadre1, textvariable=cacher, bg="black", font=("Consolas", 20, "bold"), fg="white"
)
